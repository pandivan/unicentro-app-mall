  ...
  return(
    <ScrollView showsVerticalScrollIndicator ={false}>
      <Center flex={1} px="3" justifyContent="flex-start" backgroundColor="white" borderColor_="red.600" borderWidth_="1">
        ...
        <Box mt="5" mb="2" width="100%" height="48" shadow_="2" backgroundColor="white" borderRadius_="10" borderColor_="red.600" borderWidth_="1">
          ...
          <HStack space={4} mt="6" alignItems="center" justifyContent="center" borderColor_="red.500" borderWidth_="1">
            ...
            <VStack>
              ...
              <Text fontSize="xs" color="#f18032" onPress={() => openApp("tel:"+offerDetail.store.phone)}>
