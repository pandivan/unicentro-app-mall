...
const Home = () =>
{
  ...
  return (
    <Center flex={0.9} px="2" backgroundColor="black" justifyContent={"flex-start"} alignItems="flex-start" width="100%" borderColor_="black" borderWidth_="3">
        ...
        <Box background="warning.400" width="100%" p="5" rounded="15" shadow={3} height="192" mb="5" borderColor_="green.500" borderWidth_="3">
          <HStack space="3" borderColor="red.500" borderWidth="3">
            <Image key={"1"} size="xl" borderColor_="black" borderWidth_="3" resizeMode="cover" source={require("../../../assets/grap1.png")} alt={"Alternate Text sm"} />
            <Image key={"2"} size="xl" borderColor_="blue.700" borderWidth_="3" resizeMode="cover" source={require("../../../assets/grap2.png")} alt={"Alternate Text sm"} />
          </HStack>
        </Box>
          
        <HStack justifyContent="center" width="100%" space="3" borderColor_="dark.200" borderWidth_="3">
